...
| `BROADCOM` | `None` | `Broadcom` | `Registry.ROR` | `035gt5s03` |
| `BRUKER` | `None` | `Bruker` | `Registry.ROR` | `04r739x86` |
...
| `EXCELITAS_TECHNOLOGIES` | `None` | `Excelitas Technologies` | `Registry.ROR` | `01tpbbf75` |
...
| `KENT_SCIENTIFIC_CORPORATION` | `None` | `Kent Scientific Corporation` | `Registry.ROR` | `03xkj6a08` |
...
| `OXFORD_INSTRUMENTS` | `None` | `Oxford Instruments` | `Registry.ROR` | `01age2z78` |
...
| `SCIENTIFICA` | `None` | `Scientifica` | `Registry.ROR` | `00z72df47` |
...
| `WPI` | `WPI` | `World Precision Intstruments` | `Registry.ROR` | `03st5df34` |
