...
| Name | abbreviation | model_computed_fields | model_extra | model_fields_set | name | registry | registry_identifier |
|------|------|------|------|------|------|------|------|
| `AA_OPTO_ELECTRONIC` | `None` | `{}` | `None` | `set()` | `AA Opto Electronic` | `None` | `None` |
| `ABCAM` | `None` | `{}` | `None` | `set()` | `Abcam` | `name='Research Organization Registry' abbreviation='ROR'` | `02e1wjw63` |
| `ADDGENE` | `None` | `{}` | `None` | `set()` | `Addgene` | `name='Research Organization Registry' abbreviation='ROR'` | `01nn1pw54` |
| `AI` | `AI` | `{}` | `None` | `set()` | `Allen Institute` | `name='Research Organization Registry' abbreviation='ROR'` | `03cpe7c52` |
| `AIBS` | `AIBS` | `{}` | `None` | `set()` | `Allen Institute for Brain Science` | `name='Research Organization Registry' abbreviation='ROR'` | `00dcv1019` |
| `AILIPU` | `Ailipu` | `{}` | `None` | `set()` | `Ailipu Technology Co` | `None` | `None` |
| `AIND` | `AIND` | `{}` | `None` | `set()` | `Allen Institute for Neural Dynamics` | `name='Research Organization Registry' abbreviation='ROR'` | `04szwah67` |
| `AMS_OSRAM` | `None` | `{}` | `None` | `set()` | `ams OSRAM` | `name='Research Organization Registry' abbreviation='ROR'` | `045d0h266` |
| `ARECONT_VISION_COSTAR` | `None` | `{}` | `None` | `set()` | `Arecont Vision Costar` | `None` | `None` |
| `ASI` | `ASI` | `{}` | `None` | `set()` | `Applied Scientific Instrumentation` | `None` | `None` |
| `ASUS` | `None` | `{}` | `None` | `set()` | `ASUS` | `name='Research Organization Registry' abbreviation='ROR'` | `00bxkz165` |
| `BASLER` | `None` | `{}` | `None` | `set()` | `Basler` | `None` | `None` |
| `BCM` | `BCM` | `{}` | `None` | `set()` | `Baylor College of Medicine` | `name='Research Organization Registry' abbreviation='ROR'` | `02pttbw34` |
...
| `COLUMBIA` | `Columbia` | `{}` | `None` | `set()` | `Columbia University` | `name='Research Organization Registry' abbreviation='ROR'` | `00hj8s172` |
| `COMPUTAR` | `None` | `{}` | `None` | `set()` | `Computar` | `None` | `None` |
| `CONOPTICS` | `None` | `{}` | `None` | `set()` | `Conoptics` | `None` | `None` |
...
| `EALING` | `None` | `{}` | `None` | `set()` | `Ealing` | `None` | `None` |
...
| `IDT` | `IDT` | `{}` | `None` | `set()` | `Integrated DNA Technologies` | `name='Research Organization Registry' abbreviation='ROR'` | `009jvpf03` |
| `IMEC` | `IMEC` | `{}` | `None` | `set()` | `Interuniversity Microelectronics Center` | `name='Research Organization Registry' abbreviation='ROR'` | `02kcbn207` |
| `INFINITY_PHOTO_OPTICAL` | `None` | `{}` | `None` | `set()` | `Infinity Photo-Optical` | `None` | `None` |
| `INVITROGEN` | `None` | `{}` | `None` | `set()` | `Invitrogen` | `name='Research Organization Registry' abbreviation='ROR'` | `03x1ewr52` |
| `IR_ROBOT_CO` | `None` | `{}` | `None` | `set()` | `IR Robot Co` | `None` | `None` |
| `ISL` | `ISL` | `{}` | `None` | `set()` | `ISL Products International` | `None` | `None` |
| `ITEM` | `None` | `{}` | `None` | `set()` | `Item` | `None` | `None` |
| `JANELIA` | `Janelia` | `{}` | `None` | `set()` | `Janelia Research Campus` | `name='Research Organization Registry' abbreviation='ROR'` | `013sk6x84` |
| `JAX` | `JAX` | `{}` | `None` | `set()` | `Jackson Laboratory` | `name='Research Organization Registry' abbreviation='ROR'` | `021sy4w91` |
...
| `MIDOPT` | `MidOpt` | `{}` | `None` | `set()` | `Midwest Optical Systems, Inc.` | `None` | `None` |
| `MIT` | `MIT` | `{}` | `None` | `set()` | `Massachusetts Institute of Technology` | `name='Research Organization Registry' abbreviation='ROR'` | `042nb2s44` |
| `MITUTUYO` | `None` | `{}` | `None` | `set()` | `Mitutuyo` | `None` | `None` |
...
| `NCCIH` | `NCCIH` | `{}` | `None` | `set()` | `National Center for Complementary and Integrative Health` | `name='Research Organization Registry' abbreviation='ROR'` | `00190t495` |
| `NEUROPHOTOMETRICS` | `None` | `{}` | `None` | `set()` | `Neurophotometrics` | `None` | `None` |
| `NEW_SCALE_TECHNOLOGIES` | `None` | `{}` | `None` | `set()` | `New Scale Technologies` | `None` | `None` |
| `NIKON` | `None` | `{}` | `None` | `set()` | `Nikon` | `name='Research Organization Registry' abbreviation='ROR'` | `0280y9h11` |
| `NIMH` | `NIMH` | `{}` | `None` | `set()` | `National Institute of Mental Health` | `name='Research Organization Registry' abbreviation='ROR'` | `04xeg9z08` |
| `NINDS` | `NINDS` | `{}` | `None` | `set()` | `National Institute of Neurological Disorders and Stroke` | `name='Research Organization Registry' abbreviation='ROR'` | `01s5ya894` |
| `NRESEARCH_INC` | `None` | `{}` | `None` | `set()` | `NResearch Inc` | `None` | `None` |
| `NYU` | `NYU` | `{}` | `None` | `set()` | `New York University` | `name='Research Organization Registry' abbreviation='ROR'` | `0190ak572` |
| `OEPS` | `OEPS` | `{}` | `None` | `set()` | `Open Ephys Production Site` | `name='Research Organization Registry' abbreviation='ROR'` | `007rkz355` |
| `OLYMPUS` | `None` | `{}` | `None` | `set()` | `Olympus` | `name='Research Organization Registry' abbreviation='ROR'` | `02vcdte90` |
| `OPTOTUNE` | `None` | `{}` | `None` | `set()` | `Optotune` | `None` | `None` |
| `OTHER` | `None` | `{}` | `None` | `set()` | `Other` | `None` | `None` |
| `OXXIUS` | `None` | `{}` | `None` | `set()` | `Oxxius` | `None` | `None` |
| `PLACID_INDUSTRIES` | `None` | `{}` | `None` | `set()` | `Placid Industries` | `None` | `None` |
...
| `SEMROCK` | `None` | `{}` | `None` | `set()` | `Semrock` | `None` | `None` |
...
| `THE_LEE_COMPANY` | `None` | `{}` | `None` | `set()` | `The Lee Company` | `None` | `None` |
| `THORLABS` | `None` | `{}` | `None` | `set()` | `Thorlabs` | `name='Research Organization Registry' abbreviation='ROR'` | `04gsnvb07` |
| `TMC` | `TMC` | `{}` | `None` | `set()` | `Technical Manufacturing Corporation` | `None` | `None` |
| `TRANSDUCER_TECHNIQUES` | `None` | `{}` | `None` | `set()` | `Transducer Techniques` | `None` | `None` |
| `TWCF` | `TWCF` | `{}` | `None` | `set()` | `Templeton World Charity Foundation` | `name='Research Organization Registry' abbreviation='ROR'` | `00x0z1472` |
| `TYMPHANY` | `None` | `{}` | `None` | `set()` | `Tymphany` | `None` | `None` |
| `UCSD` | `UCSD` | `{}` | `None` | `set()` | `University of California, San Diego` | `name='Research Organization Registry' abbreviation='ROR'` | `0168r3w48` |
| `VIEWORKS` | `None` | `{}` | `None` | `set()` | `Vieworks` | `None` | `None` |
| `VORTRAN` | `None` | `{}` | `None` | `set()` | `Vortran` | `None` | `None` |
