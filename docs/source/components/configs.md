...
| Field | Type | Title (Description) |
|-------|------|-------------|
| `channel_configs` | List[[OlfactometerChannelConfig](stimulus.md#olfactometerchannelconfig)] | Channel configurations (List of channels with their odorant and concentration) |
| `device_name` | `str` | Device name (Must match a device defined in the instrument.json) |
