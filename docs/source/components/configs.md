...
| `transform` | Optional[List[[Translation](components/coordinates.md#translation) or [Rotation](components/coordinates.md#rotation) or [Scale](components/coordinates.md#scale) or [Affine](components/coordinates.md#affine)]] |  |
...
| `detector` | [DetectorConfig](components/configs.md#detectorconfig) |  |
| `additional_device_names` | Optional[List[[DeviceConfig](components/configs.md#deviceconfig)]] | Mirrors, dichroics, etc |
| `light_sources` | List[[LaserConfig](components/configs.md#laserconfig) or [LightEmittingDiodeConfig](components/configs.md#lightemittingdiodeconfig)] |  |
| `variable_power` | `Optional[bool]` | Set to true when the power varies across Planes -- put the power in the Plane.power field |
| `excitation_filters` | Optional[List[[DeviceConfig](components/configs.md#deviceconfig)]] |  |
| `emission_filters` | Optional[List[[DeviceConfig](components/configs.md#deviceconfig)]] |  |
...
| `targeted_structure` | [BrainAtlas](https://github.com/AllenNeuralDynamics/aind-data-schema-models/blob/main/src/aind_data_schema_models/brain_atlas.py) |  |
...
| `compression` | Optional[[Code](components/identifiers.md#code)] | Compression algorithm used during acquisition |
| `device_name` | `str` | Must match a device defined in the instrument.json |
...
| Field | Type | Description |
|-------|------|-------------|
| `manipulator` | [ManipulatorConfig](components/configs.md#manipulatorconfig) |  |
| `probes` | List[[ProbeConfig](components/configs.md#probeconfig)] |  |
| `modules` | Optional[List[[MISModuleConfig](components/configs.md#mismoduleconfig)]] | Configurations for conveniently tracking manipulator modules, e.g. on the New Scale dome. |
| `device_name` | `str` | Must match a device defined in the instrument.json |
...
| `manipulator` | [ManipulatorConfig](components/configs.md#manipulatorconfig) |  |
| `probes` | List[[ProbeConfig](components/configs.md#probeconfig)] |  |
| `patch_cords` | List[[PatchCordConfig](components/configs.md#patchcordconfig)] |  |
| `device_name` | `str` | Must match a device defined in the instrument.json |
...
| `image_to_acquisition_transform` | List[[Translation](components/coordinates.md#translation) or [Rotation](components/coordinates.md#rotation) or [Scale](components/coordinates.md#scale) or [Affine](components/coordinates.md#affine)] | Position, rotation, and scale of the image. Note that depth should be in the planes. |
| `dimensions` | Optional[[Scale](components/coordinates.md#scale)] |  |
...
| `coordinate_system` | Optional[[CoordinateSystem](components/coordinates.md#coordinatesystem)] | Required for ImageSPIM objects and when the imaging coordinate system differs from the Acquisition.coordinate_system |
...
| `sampling_strategy` | Optional[[SamplingStrategy](components/configs.md#samplingstrategy)] |  |
| `device_name` | `str` | Must match a device defined in the instrument.json |
...
| `relative_position` | `List[AnatomicalRelative]` |  |
| `coordinate_system` | Optional[[CoordinateSystem](components/coordinates.md#coordinatesystem)] |  |
| `transform` | Optional[List[[Translation](components/coordinates.md#translation) or [Rotation](components/coordinates.md#rotation) or [Scale](components/coordinates.md#scale) or [Affine](components/coordinates.md#affine)]] | Entry coordinate, depth, and rotation in the Acquisition.coordinate_system |
| `notes` | `Optional[str]` |  |
| `device_name` | `str` | Must match a device defined in the instrument.json |
...
| `scan_coordinate_system` | Optional[[CoordinateSystem](components/coordinates.md#coordinatesystem)] |  |
| `scan_affine_transform` | Optional[List[[Translation](components/coordinates.md#translation) or [Rotation](components/coordinates.md#rotation) or [Scale](components/coordinates.md#scale) or [Affine](components/coordinates.md#affine)]] | NIFTI sform/qform, Bruker vc_transform, etc |
| `subject_position` | `SubjectPosition` |  |
| `resolution` | Optional[[Scale](components/coordinates.md#scale)] |  |
...
| `local_axis_positions` | [Translation](components/coordinates.md#translation) |  |
| `device_name` | `str` | Must match a device defined in the instrument.json |
...
| Field | Type | Description |
|-------|------|-------------|
| `channels` | List[[Channel](components/configs.md#channel)] |  |
| `device_name` | `str` | Must match a device defined in the instrument.json |
...
| Field | Type | Description |
|-------|------|-------------|
| `primary_targeted_structure` | [BrainAtlas](https://github.com/AllenNeuralDynamics/aind-data-schema-models/blob/main/src/aind_data_schema_models/brain_atlas.py) |  |
| `other_targeted_structure` | Optional[List[[BrainAtlas](https://github.com/AllenNeuralDynamics/aind-data-schema-models/blob/main/src/aind_data_schema_models/brain_atlas.py)]] |  |
| `atlas_coordinate` | Optional[[AtlasCoordinate](components/coordinates.md#atlascoordinate)] |  |
| `coordinate_system` | [CoordinateSystem](components/coordinates.md#coordinatesystem) |  |
| `transform` | List[[Translation](components/coordinates.md#translation) or [Rotation](components/coordinates.md#rotation) or [Scale](components/coordinates.md#scale) or [Affine](components/coordinates.md#affine)] | Entry coordinate, depth, and rotation in the Acquisition.coordinate_system |
| `dye` | `Optional[str]` |  |
| `notes` | `Optional[str]` |  |
| `device_name` | `str` | Must match a device defined in the instrument.json |
...
| Field | Type | Description |
|-------|------|-------------|
| `chamber_immersion` | [Immersion](components/configs.md#immersion) |  |
| `sample_immersion` | Optional[[Immersion](components/configs.md#immersion)] |  |
| `device_name` | `str` | Must match a device defined in the instrument.json |
