...
laser_assembly = LaserAssembly(
    ...
    manipulator=Manipulator(serial_number="SN2937", manufacturer=NEW_SCALE_TECHNOLOGIES),
...
stick_lens = Lens(manufacturer=EDMUND_OPTICS)
...
ephys_assemblyA = EphysAssembly(
    ...
    manipulator=Manipulator(serial_number="SN2938", manufacturer=NEW_SCALE_TECHNOLOGIES),
    probes=[probeA],
)

ephys_assemblyB = EphysAssembly(
    ephys_assembly_name="Ephys_assemblyB",
    manipulator=Manipulator(serial_number="SN2939", manufacturer=NEW_SCALE_TECHNOLOGIES),
    probes=[probeB],
)
...
lens = Lens(focal_length=15, manufacturer=EDMUND_OPTICS, max_aperture="f/2")
