...
fov_indices = {"Path 1": [1, 1], "Path 2": [2, 2]}
...
slap2_plane_rois_raster = {
    "Path 1": [
        Slap2Plane(  # each fastZ plane will get its own Slap2Plane
            ...
            fov_index=fov_indices["Path 1"][0],
        ...
        Slap2Plane(  # each fastZ plane will get its own Slap2Plane
            ...
            targeted_structure=CCFv3.VISPL2_3,
            specimen_id=f"{mouse_id}_{imaging_target_name}",
            fov_index=fov_indices["Path 1"][1],
    ...
    "Path 2": [
        Slap2Plane(  # each fastZ plane will get its own Slap2Plane
            ...
            targeted_structure=CCFv3.VISPL2_3,
            specimen_id=f"{mouse_id}_{imaging_target_name}",
            fov_index=fov_indices["Path 2"][0],
        ...
        Slap2Plane(  # each fastZ plane will get its own Slap2Plane
            ...
            targeted_structure=CCFv3.VISPL2_3,
            specimen_id=f"{mouse_id}_{imaging_target_name}",
            fov_index=fov_indices["Path 2"][1],
