...
class LightCycle(MetadataModel):
...
class WellnessReport(MetadataModel):
...
class BreedingInfo(MetadataModel):
...
class Subject(MetadataCoreModel):
    """Description of a subject of data collection"""

    _DESCRIBED_BY_URL = MetadataCoreModel._DESCRIBED_BY_BASE_URL.default + "aind_data_schema/core/subject.py"
