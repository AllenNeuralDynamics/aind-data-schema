...
class DAQDevice(Device):
    ...
    # required fields
    daq_device_type: Literal["DaqDevice"] = Field(
        default="DaqDevice", title="Daq Device Type", const=True, readOnly=True
    )
    data_interface: DataInterface = Field(..., title="Type of connection to PC")
    manufacturer: EnumSubset[
...
class HarpDevice(DAQDevice):
    ...
    # required fields
    daq_device_type: Literal["HarpDevice"] = Field(
        default="HarpDevice", title="Daq Device Type", const=True, readOnly=True
    )
...
class Laser(Device):
    ...
    # required fields
    lightsource_type: Literal["Laser"] = Field(default="Laser", title="Lightsource type", const=True, readOnly=True)
    manufacturer: EnumSubset[
...
class Disc(MousePlatform):
    ...
    platform_type: Literal["Disc"] = Field(default="Disc", title="Platform type", const=True)
...
class Wheel(MousePlatform):
    ...
    platform_type: Literal["Wheel"] = Field(default="Wheel", title="Platform type", const=True)
...
class Tube(MousePlatform):
    ...
    platform_type: Literal["Tube"] = Field(default="Tube", title="Platform type", const=True, readOnly=True)
...
class Treadmill(MousePlatform):
    ...
    platform_type: Literal["Treadmill"] = Field(default="Treadmill", title="Platform type", const=True, readOnly=True)
...
class Monitor(Device):
    ...
    stimulus_device: Literal["Visual monitor"] = Field(
        default="Visual monitor", title="Stimulus type", const=True, readOnly=True
    )
...
class RewardDelivery(AindModel):
    ...
    stimulus_device: Literal["Reward delivery"] = Field(
        default="Reward delivery", title="Stimulus type", const=True, readOnly=True
    )
...
class Speaker(Device):
    ...
    stimulus_device: Literal["Speaker"] = Field(default="Speaker", title="Stimulus type", const=True, readOnly=True)
