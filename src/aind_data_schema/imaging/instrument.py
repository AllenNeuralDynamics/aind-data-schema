...
class Instrument(BaseModel):
    ...
    describedBy: str = Field('https://github.com/AllenNeuralDynamics/aind-data-schema/blob/main/src/aind-data-schema/imaging/instrument.py', description='The URL reference to the schema.', title='Described by', const=True)
