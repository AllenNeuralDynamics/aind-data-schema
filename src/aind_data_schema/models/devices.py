...
class MotorizedStage(Device):
    ...
    device_type: Constant("Motorized stage")
...
class Objective(Device):
    ...
    device_type: Constant("Objective")
...
class DAQDevice(Device):
    ...
    # required fields
    device_type: Constant("DAQ Device")
    data_interface: DataInterface = Field(..., title="Type of connection to PC")
...
class HarpDevice(DAQDevice):
    ...
    # required fields
    device_type: Constant("Harp device")
    ...
    data_interface: Constant(DataInterface.USB)
...
class LightEmittingDiode(Device):
    ...
    device_type: Constant("Light emitting diode")
...
class NeuropixelsBasestation(DAQDevice):
    ...
    # required fields
    device_type: Constant("Neuropixels basestation")
    ...
    # fixed values
    data_interface: Constant(DataInterface.PXI)
...
class OpenEphysAcquisitionBoard(DAQDevice):
    ...
    # required fields
    device_type: Constant("Open Ephys Acquisition Board")
...
class Manipulator(Device):
    ...
    device_type: Constant("Manipulator")
...
class Headstage(Device):
    ...
    device_type: Constant("Headstage")
...
class EphysProbe(Device):
    ...
    # required fields
    device_type: Constant("Ephys probe")
...
class Detector(Device):
    ...
    size_unit: Constant(SizeUnit.PX, title="Size unit")
    ...
    bin_unit: Optional[SizeUnit] = Field(SizeUnit.PX, title="Bin size unit")
    ...
    crop_unit: Optional[SizeUnit] = Field(SizeUnit.PX, title="Crop size unit")


class FiberProbe(Device):
    """Description of a fiber optic probe"""

    device_type: Constant("Fiber optic probe")
...
class DigitalMicromirrorDevice(Device):
    ...
    device_type: Constant("Digital Micromirror Device")
...
class PolygonalScanner(Device):
    ...
    device_type: Constant("Polygonal Scanner")
...
class PockelsCell(Device):
    ...
    device_type: Constant("Pockels Cell")
...
class Enclosure(Device):
    ...
    device_type: Constant("Enclosure")
...
class MousePlatform(Device):
    ...
    device_type: Constant("Mouse platform")
...
class Treadmill(MousePlatform):
    ...
    device_type: Constant("Treadmill")
...
class RewardSpout(Device):
    ...
    device_type: Constant("Reward spout")
...
class RewardDelivery(AindModel):
    ...
    device_type: Constant("Reward delivery")
...
class Olfactometer(Device):
    ...
    device_type: Constant("Olfactometer")
    position: Optional[RelativePosition] = Field(None, title="Relative position of the monitor")
...
class AdditionalImagingDevice(Device):
    ...
    device_type: Constant("AdditionalImagingDevice")
...
class OpticalTable(Device):
    ...
    device_type: Constant("OpticalTable")
