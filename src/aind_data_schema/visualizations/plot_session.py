...
def plot_session(datapath, savepath, ):
    ...
    for stream in d['data_streams']:
        ...
        ax.hlines(1, mdates.date2num(stream_start_time), mdates.date2num(stream_end_time), linewidth=8,
                  alpha=0.3, color='r')
    ...
    for epoch in d['stimulus_epochs']:
        ...
        ax.hlines(2, mdates.date2num(stimulus_start_time), mdates.date2num(stimulus_end_time), linewidth=8,
                  alpha=0.3)
