...
class ImagingTests(unittest.TestCase):
    ...
    def test_constructors(self):
        ...
        a = acq.Acquisition(
            ...
            session_start_time=datetime.now(tz=timezone.utc).astimezone(tz=timezone.utc),
            specimen_id="12345",
            subject_id="1234",
            instrument_id="1234",
            calibrations=[
                Calibration(
                    calibration_date=datetime.now(tz=timezone.utc).astimezone(tz=timezone.utc),
            ...
            session_end_time=datetime.now(tz=timezone.utc).astimezone(tz=timezone.utc),
    ...
    def test_registration(self):
        ...
        t = Registration(
            ...
            start_date_time=datetime.now(tz=timezone.utc).astimezone(tz=timezone.utc),
            end_date_time=datetime.now(tz=timezone.utc).astimezone(tz=timezone.utc),
